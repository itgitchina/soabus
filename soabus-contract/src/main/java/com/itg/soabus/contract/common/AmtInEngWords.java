package com.itg.soabus.contract.common;
...
public class AmtInEngWords {
	...
	static public class UnitProcessor extends AbstractProcessor {
		...
		static private final String[] TOKENS = new String[] { "one", "two",
	...
	static public class TensProcessor extends AbstractProcessor {
		...
		static private final String[] TOKENS = new String[] { "twenty",
	...
	static public class DefaultProcessor extends AbstractProcessor {
		...
		public String getName(String value) {
			...
			if (!(null == decimalValue || decimalValue.isEmpty())) {
				name = name.concat(SEPARATOR).concat(UNION_AND)
						.concat(SEPARATOR)
